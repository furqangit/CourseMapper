    ...
    Review.find(
        {
            ...
            assignedTo: params.peerId,
            isSubmitted: true,
            isAdminReview: false,
            peerReviewId: { $ne: params.peerReviewId },
            dateAdded: { $lte: params.date}
        }
    )
...
reviews.prototype.getReviewsForGrade = function (error, params, success) {
    Review.find({ 
        courseId: params.courseId, 
        submittedBy: params.peerId, 
        isAdminReview: true, 
        isSubmitted: true, 
        peerReviewId: { $ne: params.peerReviewId },
        dateAdded: { $lt: params.date}
    })
...
reviews.prototype.editReview = function (error, params, files, success) {
    ...
    Review.findOne({
        ...
        review.reviewRatings = params.reviewRatings
...
reviews.prototype.updateReviewRating = function (error, params, files, success) {
    var self = this;
